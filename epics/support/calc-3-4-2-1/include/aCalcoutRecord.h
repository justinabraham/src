...
#ifndef INCacalcoutSIZEH
#define INCacalcoutSIZEH
typedef enum {
	acalcoutSIZE_NELM,
	acalcoutSIZE_NUSE
}acalcoutSIZE;
#endif /*INCacalcoutSIZEH*/
...
#define acalcoutRecordCACT	175
#define acalcoutRecordCSTAT	176
#define acalcoutRecordAMASK	177
#define acalcoutRecordSIZE	178
#endif /*INCacalcoutH*/
...
static int acalcoutRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  assert(pdbRecordType->no_fields==179);
  ...
  pdbRecordType->papFldDes[153]->size=sizeof(prec->newm);
  pdbRecordType->papFldDes[153]->offset=(short)((char *)&prec->newm - (char *)prec);
  ...
  pdbRecordType->papFldDes[175]->size=sizeof(prec->cact);
  pdbRecordType->papFldDes[175]->offset=(short)((char *)&prec->cact - (char *)prec);
  pdbRecordType->papFldDes[176]->size=sizeof(prec->cstat);
  pdbRecordType->papFldDes[176]->offset=(short)((char *)&prec->cstat - (char *)prec);
  pdbRecordType->papFldDes[177]->size=sizeof(prec->amask);
  pdbRecordType->papFldDes[177]->offset=(short)((char *)&prec->amask - (char *)prec);
  pdbRecordType->papFldDes[178]->size=sizeof(prec->size);
  pdbRecordType->papFldDes[178]->offset=(short)((char *)&prec->size - (char *)prec);
