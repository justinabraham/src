...
/* Generated from ../O.Common/testArrayRingBuffer.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "devLsiSoft", "devLsoSoft", "devLsoSoftCallback", "devLsoStdio",
    ...
    "devSiGeneralTime", "asynSiOctetCmdResponse", "asynSiOctetWriteRead",
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_testArrayRingBufferRegister, pvar_func_tsInitialize;
...
int testArrayRingBuffer_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/justin/epicsdev/support/asyn-4-26";
    ...
    pvar_func_testArrayRingBufferRegister();
    pvar_func_tsInitialize();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* testArrayRingBuffer_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testArrayRingBuffer_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testArrayRingBuffer_registerRecordDeviceDriver(*iocshPpdbbase);
}
