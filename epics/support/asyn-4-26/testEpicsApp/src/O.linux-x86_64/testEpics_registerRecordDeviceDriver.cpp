...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_dbndInitialize, pvar_func_echoDriverRegister,
    pvar_func_int32DriverRegister, pvar_func_syncInitialize,
    pvar_func_tsInitialize, pvar_func_uint32DigitalDriverRegister;
