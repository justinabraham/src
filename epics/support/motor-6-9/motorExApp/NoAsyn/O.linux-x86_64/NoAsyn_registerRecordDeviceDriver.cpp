...
/* Generated from ../O.Common/NoAsyn.dbd */
...
epicsShareExtern int *pvar_int_motorRecordDebug;
static struct iocshVarDef vardefs[] = {
	...
	{"motorRecordDebug", iocshArgInt, (void * const)pvar_int_motorRecordDebug},
	{NULL, iocshArgInt, NULL}
};

int NoAsyn_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"NoAsyn_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    NoAsyn_registerRecordDeviceDriver(*iocshPpdbbase);
}
