...
/* Generated from ../O.Common/motorSim.dbd */
...
static const char * const deviceSupportNames[83] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[83] = {
...
int motorSim_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/justin/epicsdev/support/motor-6-9";
    ...
    registerDevices(pbase, 83, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"motorSim_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    motorSim_registerRecordDeviceDriver(*iocshPpdbbase);
}
