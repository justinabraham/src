...
#define timestampRecordVAL	43
#define timestampRecordOVAL	44
#define timestampRecordRVAL	45
#define timestampRecordTST	46
#endif /*INCtimestampH*/
...
static int timestampRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  assert(pdbRecordType->no_fields==47);
  ...
  pdbRecordType->papFldDes[46]->size=sizeof(prec->tst);
  pdbRecordType->papFldDes[46]->offset=(short)((char *)&prec->tst - (char *)prec);
