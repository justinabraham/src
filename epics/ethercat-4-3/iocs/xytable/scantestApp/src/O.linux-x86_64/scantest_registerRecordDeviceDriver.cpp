...
epicsShareExtern void (*pvar_func_snlStepperMotorSequencerRegistrar)(void);
...
{
    const char *bldTop = "/epics/ethercat-4-3/iocs/xytable";
    ...
    (*pvar_func_snlStepperMotorSequencerRegistrar)();
