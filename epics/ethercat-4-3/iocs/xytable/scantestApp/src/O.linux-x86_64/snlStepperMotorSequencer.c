...
# line 142 "../snlStepperMotorSequencer.stt"
	...
	memcpy(&seqg_var->MS_MULT, &seqg_initvar_MS_MULT, sizeof(seqg_initvar_MS_MULT));
	}
}
...
# line 163 "../snlStepperMotorSequencer.stt"
	seqg_var->fanout_snlState_val = 1;
...
# line 169 "../snlStepperMotorSequencer.stt"
	if (seqg_var->isCalibrated == 0)
	{
# line 171 "../snlStepperMotorSequencer.stt"
		seqg_var->sleep.tv_nsec = (int)(500 * seqg_var->MS_MULT);
# line 172 "../snlStepperMotorSequencer.stt"
		nanosleep(&seqg_var->sleep, NULL);
...
# line 192 "../snlStepperMotorSequencer.stt"
	if ((seqg_var->enable_automode == 1) && (fabs(seqg_var->setpoint - seqg_var->readback) > seqg_var->CL_deadband))
	{
		*seqg_pnst = 2;
		*seqg_ptrn = 2;
		return TRUE;
...
# line 183 "../snlStepperMotorSequencer.stt"
			seqg_var->pre_CL_setpoint_dist = seqg_var->setpoint;
# line 184 "../snlStepperMotorSequencer.stt"
			seqg_var->auto_transition = 0;
		}
		return;
	case 1:
		{
...
# line 222 "../snlStepperMotorSequencer.stt"
	seqg_var->fanout_snlState_val = 2;
...
# line 227 "../snlStepperMotorSequencer.stt"
	if (seqg_var->enable_automode == 1)
	{
# line 229 "../snlStepperMotorSequencer.stt"
		seqg_var->setpoint = seqg_var->pre_CL_setpoint_dist;
...
# line 231 "../snlStepperMotorSequencer.stt"
		if (fabs(seqg_var->setpoint - seqg_var->readback) > seqg_var->CL_deadband)
		{
# line 232 "../snlStepperMotorSequencer.stt"
			seqg_var->driveEnable = 1;
...
# line 247 "../snlStepperMotorSequencer.stt"
	if (seqg_var->enable_automode == 1 && seqg_var->auto_transition == 1 && seqg_var->driveEnable == 0)
	{
		*seqg_pnst = 0;
		*seqg_ptrn = 2;
		return TRUE;
...
static seqChan seqg_chans[] = {
	...
	{"{MotorDrive}:ENCCONTROLCOMPACT:SETCOUNTERVALUE", offsetof(struct seqg_vars, setCounterValue), "setCounterValue", P_DOUBLE, 1, 1, 0, 1, 0, 0},
	{"{MotorDrive}:ENCCONTROLCOMPACT:CONTROL__SETCOUNTER", offsetof(struct seqg_vars, setCounterControl), "setCounterControl", P_DOUBLE, 1, 2, 0, 1, 0, 0},
	{"{MotorDrive}:STMVELOCITY:VELOCITY", offsetof(struct seqg_vars, driveVelocity), "driveVelocity", P_DOUBLE, 1, 3, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:snlState", offsetof(struct seqg_vars, snlState), "snlState", P_DOUBLE, 1, 4, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:encCalc", offsetof(struct seqg_vars, encCalc), "encCalc", P_DOUBLE, 1, 5, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:encCalc_ENG", offsetof(struct seqg_vars, encCalc_ENG), "encCalc_ENG", P_DOUBLE, 1, 6, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:potChVal", offsetof(struct seqg_vars, potChVal), "potChVal", P_DOUBLE, 1, 7, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:potChVal_ENG", offsetof(struct seqg_vars, potChVal_ENG), "potChVal_ENG", P_DOUBLE, 1, 8, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:internalCounterVal", offsetof(struct seqg_vars, internalCounterVal), "internalCounterVal", P_DOUBLE, 1, 9, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:internalCounterVal_ENG", offsetof(struct seqg_vars, internalCounterVal_ENG), "internalCounterVal_ENG", P_DOUBLE, 1, 10, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:OUFlowCount", offsetof(struct seqg_vars, OUFlowCount), "OUFlowCount", P_DOUBLE, 1, 11, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:snlCLFeedback", offsetof(struct seqg_vars, snlCLFeedback), "snlCLFeedback", P_DOUBLE, 1, 12, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:dist_Encoder", offsetof(struct seqg_vars, dist_Encoder), "dist_Encoder", P_DOUBLE, 1, 13, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:dist_Counter", offsetof(struct seqg_vars, dist_Counter), "dist_Counter", P_DOUBLE, 1, 14, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:dist_Pot", offsetof(struct seqg_vars, dist_Pot), "dist_Pot", P_DOUBLE, 1, 15, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:snlFailSafe", offsetof(struct seqg_vars, snlFailSafe), "snlFailSafe", P_DOUBLE, 1, 16, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:lowerLim", offsetof(struct seqg_vars, lowerLim), "lowerLim", P_DOUBLE, 1, 17, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:isCalibrated", offsetof(struct seqg_vars, isCalibrated), "isCalibrated", P_DOUBLE, 1, 18, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:offset_Encoder", offsetof(struct seqg_vars, offset_Encoder), "offset_Encoder", P_DOUBLE, 1, 19, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:offset_Pot", offsetof(struct seqg_vars, offset_Pot), "offset_Pot", P_DOUBLE, 1, 20, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:enable_automode", offsetof(struct seqg_vars, enable_automode), "enable_automode", P_DOUBLE, 1, 21, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:setpoint", offsetof(struct seqg_vars, setpoint), "setpoint", P_DOUBLE, 1, 22, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:CL_deadband", offsetof(struct seqg_vars, CL_deadband), "CL_deadband", P_DOUBLE, 1, 23, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:readback", offsetof(struct seqg_vars, readback), "readback", P_DOUBLE, 1, 24, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:driveEnable", offsetof(struct seqg_vars, driveEnable), "driveEnable", P_DOUBLE, 1, 25, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:state_automode", offsetof(struct seqg_vars, state_automode), "state_automode", P_DOUBLE, 1, 26, 0, 1, 0, 0},
	{"{IOC}:{DEVICE}:CL_enable", offsetof(struct seqg_vars, CL_enable), "CL_enable", P_DOUBLE, 1, 27, 0, 0, 0, 0},
	{"{IOC}:{DEVICE}:jog_enable", offsetof(struct seqg_vars, jog_enable), "jog_enable", P_DOUBLE, 1, 28, 0, 0, 0, 0},
	{"{IOC}:{DEVICE}:fanout_snlState_val", offsetof(struct seqg_vars, fanout_snlState_val), "fanout_snlState_val", P_DOUBLE, 1, 29, 0, 0, 0, 0},
	{"{IOC}:{DEVICE}:fanout_snlCLFeedback_val", offsetof(struct seqg_vars, fanout_snlCLFeedback_val), "fanout_snlCLFeedback_val", P_DOUBLE, 1, 30, 0, 0, 0, 0},
	{"{IOC}:{DEVICE}:CL_FBSensor", offsetof(struct seqg_vars, CL_FBSensor), "CL_FBSensor", P_STRING, 1, 31, 0, 0, 0, 0},
	{"{IOC}:{DEVICE}:CL_FSSensor", offsetof(struct seqg_vars, CL_FSSensor), "CL_FSSensor", P_STRING, 1, 32, 0, 0, 0, 0},
	{"{IOC}:{DEVICE}:FSErrorLim_val", offsetof(struct seqg_vars, FSErrorLim_val), "FSErrorLim_val", P_DOUBLE, 1, 33, 0, 0, 0, 0},
};
...
# line 331 "../snlStepperMotorSequencer.stt"
		strcpy(seqg_var->CL_FBSensor, "MECHANICAL ENCODER");
...
# line 402 "../snlStepperMotorSequencer.stt"
					seqg_var->setpoint = seqg_var->lowerLim;
...
# line 427 "../snlStepperMotorSequencer.stt"
	seqg_var->setCounterControl = 1;
# line 428 "../snlStepperMotorSequencer.stt"
	seq_pvPutTmo(seqg_env, 1/*setCounterControl*/, SYNC, DEFAULT_TIMEOUT);
# line 429 "../snlStepperMotorSequencer.stt"
	seqg_var->OUFlowCount = (seqg_var->offset_Encoder + seqg_var->encCalc / seqg_var->dist_Encoder) * seqg_var->dist_Counter;
...
# line 440 "../snlStepperMotorSequencer.stt"
	seqg_var->OUFlowCount = (seqg_var->offset_Pot + seqg_var->potChVal / seqg_var->dist_Pot) * seqg_var->dist_Counter;
...
# line 451 "../snlStepperMotorSequencer.stt"
	seqg_var->OUFlowCount = seqg_var->lowerLim * seqg_var->dist_Counter;
...
# line 465 "../snlStepperMotorSequencer.stt"
				seqg_var->setpoint = seqg_var->internalCounterVal_ENG;
